      ...
      >
        ...
        <div className="relative z-10 px-6 pt-5">
          <div className="mx-auto flex max-w-[1560px] items-center gap-5 rounded-[2rem] border border-[#8b6b23] bg-gradient-to-r from-[#07101f]/95 via-[#102039]/95 to-[#07101f]/95 px-7 py-5 shadow-2xl shadow-black/40">
            ...
            <div className="mt-10 max-w-4xl rounded-[2rem] border border-emerald-400/30 bg-[#031428]/85 p-6 shadow-2xl shadow-emerald-500/10 backdrop-blur-xl">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <div className="text-xs font-black uppercase tracking-[.3em] text-emerald-300">Client Success Stories</div>
                  <h3 className="mt-2 text-3xl font-black leading-tight text-white">
                    Homeowners Love The Faster Process
                  </h3>
                </div>
                <div className="rounded-full border border-emerald-400/30 bg-emerald-400/10 px-4 py-2 text-sm font-black text-emerald-200">
                  ★★★★★ 5-Star Experience
                </div>
              </div>

              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/[.055] p-4 shadow-lg">
                  <div className="flex items-center justify-between gap-3">
                    <div className="text-lg font-black text-white">Michael R.</div>
                    <div className="text-sm text-gold">★★★★★</div>
                  </div>
                  <div className="mt-1 text-sm font-black text-emerald-300">Fast funding review</div>
                  <p className="mt-2 text-sm font-semibold leading-relaxed text-blue-100">
                    “The process was way faster than my bank. I got clear numbers and next steps without waiting weeks.”
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[.055] p-4 shadow-lg">
                  ...
                  <div className="mt-1 text-sm font-black text-emerald-300">Less paperwork needed</div>
                  <p className="mt-2 text-sm font-semibold leading-relaxed text-blue-100">
                    “Other lenders kept asking for more documents. This was simple, organized, and much easier.”
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[.055] p-4 shadow-lg">
                  ...
                  <div className="mt-1 text-sm font-black text-emerald-300">Flexible credit situation</div>
                  <p className="mt-2 text-sm font-semibold leading-relaxed text-blue-100">
                    “I was worried because my credit score was very low. They still helped me understand possible funding options.”
                  </p>
                </div>

                <div className="rounded-2xl border border-white/10 bg-white/[.055] p-4 shadow-lg">
                  <div className="flex items-center justify-between gap-3">
                    <div className="text-lg font-black text-white">Samantha K.</div>
                    <div className="text-sm text-gold">★★★★★</div>
                  </div>
                  <div className="mt-1 text-sm font-black text-emerald-300">Better rate pathways</div>
                  <p className="mt-2 text-sm font-semibold leading-relaxed text-blue-100">
                    “The lender options looked better than what I was quoted before, and the review felt direct and professional.”
                  </p>
                </div>
              </div>

              <div className="mt-5 rounded-2xl border border-gold/20 bg-gold/10 px-4 py-3 text-center text-sm font-black text-gold">
                Built for speed, low-document reviews, flexible credit scenarios, and competitive lender options.
              </div>
            </div>
